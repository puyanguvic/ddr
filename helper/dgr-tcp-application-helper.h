...
#ifndef DGR_TCP_APPLICATION_HELPER_H
#define DGR_TCP_APPLICATION_HELPER_H
 ...
 * on a set of nodes.
 */
class DGRTcpAppHelper
{
public:
  /**
   * Create an DGRTcpAppHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  DGRTcpAppHelper (std::string protocol, Address address);
