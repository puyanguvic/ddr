...
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00003}00003\ \textcolor{preprocessor}{\#include\ "{}dgr-\/tcp-\/application-\/helper.h"{}}}
...
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00011}00011\ DGRTcpAppHelper::DGRTcpAppHelper\ (std::string\ protocol,\ Address\ address)}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00012}00012\ \{}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00013}00013\ \ \ m\_factory.SetTypeId\ (\textcolor{stringliteral}{"{}ns3::DGRTcpApplication"{}});}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00014}00014\ \ \ m\_factory.Set\ (\textcolor{stringliteral}{"{}Protocol"{}},\ StringValue\ (protocol));}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00015}00015\ \ \ m\_factory.Set\ (\textcolor{stringliteral}{"{}Remote"{}},\ AddressValue\ (address));}
...
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00019}00019\ DGRTcpAppHelper::SetAttribute\ (std::string\ name,\ \textcolor{keyword}{const}\ AttributeValue\ \&value)}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00020}00020\ \{}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00021}00021\ \ \ m\_factory.Set\ (name,\ value);}
...
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00025}00025\ DGRTcpAppHelper::Install\ (Ptr<Node>\ node)\textcolor{keyword}{\ const}}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00026}00026\ \textcolor{keyword}{}\{}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00027}00027\ \ \ \textcolor{keywordflow}{return}\ ApplicationContainer\ (InstallPriv\ (node));}
...
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00031}00031\ DGRTcpAppHelper::Install\ (std::string\ nodeName)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00034}00034\ \ \ \textcolor{keywordflow}{return}\ ApplicationContainer\ (InstallPriv\ (node));}
...
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00038}00038\ DGRTcpAppHelper::Install\ (NodeContainer\ c)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00043}00043\ \ \ \ \ \ \ apps.Add\ (InstallPriv\ (*\mbox{\hyperlink{namespacens3_aa5e169e2453984d2f21c0d5cec9e907b}{i}}));}
...
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00050}00050\ DGRTcpAppHelper::InstallPriv\ (Ptr<Node>\ node)\textcolor{keyword}{\ const}}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00051}00051\ \textcolor{keyword}{}\{}
\DoxyCodeLine{\Hypertarget{dgr-tcp-application-helper_8cc_source_l00052}00052\ \ \ Ptr<Application>\ app\ =\ m\_factory.Create<Application>\ ();}
