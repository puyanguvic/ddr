...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00017}00017\ \textcolor{preprocessor}{\#include\ "{}dgr-\/sink.h"{}}}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00018}00018\ \textcolor{preprocessor}{\#include\ "{}dgr-\/tags.h"{}}}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00024}\mbox{\hyperlink{namespacens3_a95e6077e86dcfe6f92a14f44dc7fb85f}{00024}}\ \mbox{\hyperlink{namespacens3_aef8bf32b4f2f98d854532bfb36d47a7c}{NS\_OBJECT\_ENSURE\_REGISTERED}}\ (DGRPacketSink);}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00027}00027\ DGRPacketSink::GetTypeId\ (\textcolor{keywordtype}{void})}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00030}00030\ \ \ \ \ .SetParent<Application>\ ()}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00031}00031\ \ \ \ \ .SetGroupName(\textcolor{stringliteral}{"{}Applications"{}})}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00032}00032\ \ \ \ \ .AddConstructor<DGRPacketSink>\ ()}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00036}00036\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ MakeAddressAccessor\ (\&DGRPacketSink::m\_local),}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00041}00041\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ MakeTypeIdAccessor\ (\&DGRPacketSink::m\_tid),}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00046}00046\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ MakeBooleanAccessor\ (\&DGRPacketSink::m\_enableSeqTsSizeHeader),}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00050}00050\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ MakeTraceSourceAccessor\ (\&DGRPacketSink::m\_rxTrace),}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00053}00053\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ MakeTraceSourceAccessor\ (\&DGRPacketSink::m\_rxTraceWithAddresses),}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00057}00057\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ MakeTraceSourceAccessor\ (\&DGRPacketSink::m\_rxTraceWithSeqTsSize),}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00063}00063\ DGRPacketSink::DGRPacketSink\ ()}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00066}00066\ \ \ m\_socket\ =\ 0;}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00067}00067\ \ \ m\_totalRx\ =\ 0;}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00068}00068\ \}}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00069}00069\ }
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00070}00070\ DGRPacketSink::\string~DGRPacketSink()}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00075}00075\ uint64\_t\ DGRPacketSink::GetTotalRx\ ()\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00078}00078\ \ \ \textcolor{keywordflow}{return}\ m\_totalRx;}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00082}00082\ DGRPacketSink::GetListeningSocket\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00085}00085\ \ \ \textcolor{keywordflow}{return}\ m\_socket;}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00089}00089\ DGRPacketSink::GetAcceptedSockets\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00092}00092\ \ \ \textcolor{keywordflow}{return}\ m\_socketList;}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00093}00093\ \}}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00094}00094\ }
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00095}00095\ Time\ DGRPacketSink::GetDelay(\textcolor{keyword}{const}\ Ptr<Packet>\ \&p)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00105}00105\ \textcolor{keywordtype}{void}\ DGRPacketSink::DoDispose\ (\textcolor{keywordtype}{void})}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00108}00108\ \ \ m\_socket\ =\ 0;}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00109}00109\ \ \ m\_socketList.clear\ ();}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00116}00116\ \textcolor{keywordtype}{void}\ DGRPacketSink::StartApplication\ ()\ \ \ \ \textcolor{comment}{//\ Called\ at\ time\ specified\ by\ Start}}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00120}00120\ \ \ \textcolor{keywordflow}{if}\ (!m\_socket)}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00121}00121\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00122}00122\ \ \ \ \ \ \ m\_socket\ =\ Socket::CreateSocket\ (GetNode\ (),\ m\_tid);}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00123}00123\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_socket-\/>Bind\ (m\_local)\ ==\ -\/1)}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00127}00127\ \ \ \ \ \ \ m\_socket-\/>Listen\ ();}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00128}00128\ \ \ \ \ \ \ m\_socket-\/>ShutdownSend\ ();}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00129}00129\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (addressUtils::IsMulticast\ (m\_local))}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00130}00130\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00131}00131\ \ \ \ \ \ \ \ \ \ \ Ptr<UdpSocket>\ udpSocket\ =\ DynamicCast<UdpSocket>\ (m\_socket);}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00135}00135\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ udpSocket-\/>MulticastJoinGroup\ (0,\ m\_local);}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00144}00144\ \ \ m\_socket-\/>SetRecvCallback\ (MakeCallback\ (\&DGRPacketSink::HandleRead,\ \textcolor{keyword}{this}));}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00145}00145\ \ \ m\_socket-\/>SetAcceptCallback\ (}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00147}00147\ \ \ \ \ MakeCallback\ (\&DGRPacketSink::HandleAccept,\ \textcolor{keyword}{this}));}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00148}00148\ \ \ m\_socket-\/>SetCloseCallbacks\ (}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00149}00149\ \ \ \ \ MakeCallback\ (\&DGRPacketSink::HandlePeerClose,\ \textcolor{keyword}{this}),}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00150}00150\ \ \ \ \ MakeCallback\ (\&DGRPacketSink::HandlePeerError,\ \textcolor{keyword}{this}));}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00151}00151\ \}}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00152}00152\ }
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00153}00153\ \textcolor{keywordtype}{void}\ DGRPacketSink::StopApplication\ ()\ \ \ \ \ \textcolor{comment}{//\ Called\ at\ time\ specified\ by\ Stop}}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00156}00156\ \ \ \textcolor{keywordflow}{while}(!m\_socketList.empty\ ())\ \textcolor{comment}{//these\ are\ accepted\ sockets,\ close\ them}}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00157}00157\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00158}00158\ \ \ \ \ \ \ Ptr<Socket>\ acceptedSocket\ =\ m\_socketList.front\ ();}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00159}00159\ \ \ \ \ \ \ m\_socketList.pop\_front\ ();}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00162}00162\ \ \ \textcolor{keywordflow}{if}\ (m\_socket)\ }
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00163}00163\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00164}00164\ \ \ \ \ \ \ m\_socket-\/>Close\ ();}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00165}00165\ \ \ \ \ \ \ m\_socket-\/>SetRecvCallback\ (MakeNullCallback<\textcolor{keywordtype}{void},\ Ptr<Socket>\ >\ ());}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00170}00170\ \textcolor{keywordtype}{void}\ DGRPacketSink::HandleRead\ (Ptr<Socket>\ socket)}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00190}00190\ \ \ \ \ \ \ FlagTag\ flagTag;}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00191}00191\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (packet-\/>PeekPacketTag\ (flagTag)\ \&\&\ flagTag.GetFlag\ ()\ ==\ \textcolor{keyword}{true})}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00195}00195\ \ \ \ \ \ \ \ \ std::ostream*\ os\ =\ m\_delayStream-\/>GetStream\ ();}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00196}00196\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ timeTag.GetSeconds\ ()\ <<\ "{}\ "{}\ }}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00197}00197\ \ \ \ \ \ \ \ \ BudgetTag\ bgtTag;}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00207}00207\ \ \ \ \ \ \ \ \ *os\ <<\ GetDelay\ (packet).GetMicroSeconds\ ()/1000.0\ <<\ std::endl;}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00210}00210\ \ \ \ \ \ \ m\_totalRx\ +=\ packet-\/>GetSize\ ();}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00218}00218\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ <<\ \textcolor{stringliteral}{"{}\ total\ Rx\ "{}}\ <<\ m\_totalRx\ <<\ \textcolor{stringliteral}{"{}\ bytes"{}});}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00227}00227\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ <<\ \textcolor{stringliteral}{"{}\ total\ Rx\ "{}}\ <<\ m\_totalRx\ <<\ \textcolor{stringliteral}{"{}\ bytes"{}});}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00230}00230\ \ \ \ \ \ \ m\_rxTrace\ (packet,\ from);}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00231}00231\ \ \ \ \ \ \ m\_rxTraceWithAddresses\ (packet,\ from,\ localAddress);}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00232}00232\ }
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00233}00233\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_enableSeqTsSizeHeader)}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00234}00234\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00235}00235\ \ \ \ \ \ \ \ \ \ \ PacketReceived\ (packet,\ from,\ localAddress);}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00244}00244\ DGRPacketSink::PacketReceived\ (\textcolor{keyword}{const}\ Ptr<Packet>\ \&p,\ \textcolor{keyword}{const}\ Address\ \&from,}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00250}00250\ \ \ \textcolor{keyword}{auto}\ itBuffer\ =\ m\_buffer.find\ (from);}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00251}00251\ \ \ \textcolor{keywordflow}{if}\ (itBuffer\ ==\ m\_buffer.end\ ())}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00252}00252\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00253}00253\ \ \ \ \ \ \ itBuffer\ =\ m\_buffer.insert\ (std::make\_pair\ (from,\ Create<Packet>\ (0))).first;}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00270}00270\ \ \ \ \ \ \ m\_rxTraceWithSeqTsSize\ (complete,\ from,\ localAddress,\ header);}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00283}00283\ \textcolor{keywordtype}{void}\ DGRPacketSink::HandlePeerClose\ (Ptr<Socket>\ socket)}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00288}00288\ \textcolor{keywordtype}{void}\ DGRPacketSink::HandlePeerError\ (Ptr<Socket>\ socket)}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00293}00293\ \textcolor{keywordtype}{void}\ DGRPacketSink::HandleAccept\ (Ptr<Socket>\ s,\ \textcolor{keyword}{const}\ Address\&\ from)}
...
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00296}00296\ \ \ s-\/>SetRecvCallback\ (MakeCallback\ (\&DGRPacketSink::HandleRead,\ \textcolor{keyword}{this}));}
\DoxyCodeLine{\Hypertarget{dgr-sink_8cc_source_l00297}00297\ \ \ m\_socketList.push\_back\ (s);}
