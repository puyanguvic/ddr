...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00023}00023\ \textcolor{preprocessor}{\#include\ "{}dgr-\/candidate-\/queue.h"{}}}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00024}00024\ \textcolor{preprocessor}{\#include\ "{}dgr-\/route-\/manager-\/impl.h"{}}}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00038}00038\ \mbox{\hyperlink{namespacens3_a7c0f3fcc4f4363c5458911cded1af4b6}{operator<<\ }}(std::ostream\&\ os,\ \textcolor{keyword}{const}\ DGRVertex::VertexType\&\ t)}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00042}00042\ \ \ \ \ \textcolor{keywordflow}{case}\ DGRVertex::VertexRouter:\ \ os\ <<\ \textcolor{stringliteral}{"{}router"{}};\ \textcolor{keywordflow}{break};}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00043}00043\ \ \ \ \ \textcolor{keywordflow}{case}\ DGRVertex::VertexNetwork:\ os\ <<\ \textcolor{stringliteral}{"{}network"{}};\ \textcolor{keywordflow}{break};}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00049}\mbox{\hyperlink{namespacens3_a7e46b7781873ac26626119a714c730b4}{00049}}\ std::ostream\&\ }
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00050}00050\ \mbox{\hyperlink{namespacens3_a7c0f3fcc4f4363c5458911cded1af4b6}{operator<<\ }}(std::ostream\&\ os,\ \textcolor{keyword}{const}\ DGRCandidateQueue\&\ q)}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00051}00051\ \{}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00052}00052\ \ \ \textcolor{keyword}{typedef}\ DGRCandidateQueue::DGRCandidateList\_t\ List\_t;}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00054}00054\ \ \ \textcolor{keyword}{const}\ DGRCandidateQueue::DGRCandidateList\_t\&\ list\ =\ q.m\_candidates;}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00068}00068\ DGRCandidateQueue::DGRCandidateQueue()}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00074}00074\ DGRCandidateQueue::\string~DGRCandidateQueue()}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00077}00077\ \ \ Clear\ ();}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00081}00081\ DGRCandidateQueue::Clear\ (\textcolor{keywordtype}{void})}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00084}00084\ \ \ \textcolor{keywordflow}{while}\ (!m\_candidates.empty\ ())}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00085}00085\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00086}00086\ \ \ \ \ \ \ DGRVertex\ *p\ =\ Pop\ ();}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00093}00093\ DGRCandidateQueue::Push\ (DGRVertex\ *vNew)}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00098}00098\ \ \ \ \ \ \ m\_candidates.begin\ (),\ m\_candidates.end\ (),\ vNew,}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00099}00099\ \ \ \ \ \ \ \&DGRCandidateQueue::CompareDGRVertex}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00100}00100\ \ \ \ \ \ \ );}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00101}00101\ \ \ m\_candidates.insert\ (i,\ vNew);}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00104}00104\ DGRVertex\ *}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00105}00105\ DGRCandidateQueue::Pop\ (\textcolor{keywordtype}{void})}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00108}00108\ \ \ \textcolor{keywordflow}{if}\ (m\_candidates.empty\ ())}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00113}00113\ \ \ DGRVertex\ *v\ =\ m\_candidates.front\ ();}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00114}00114\ \ \ m\_candidates.pop\_front\ ();}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00118}00118\ DGRVertex\ *}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00119}00119\ DGRCandidateQueue::Top\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00122}00122\ \ \ \textcolor{keywordflow}{if}\ (m\_candidates.empty\ ())}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00127}00127\ \ \ \textcolor{keywordflow}{return}\ m\_candidates.front\ ();}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00131}00131\ DGRCandidateQueue::Empty\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00134}00134\ \ \ \textcolor{keywordflow}{return}\ m\_candidates.empty\ ();}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00138}00138\ DGRCandidateQueue::Size\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00141}00141\ \ \ \textcolor{keywordflow}{return}\ m\_candidates.size\ ();}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00144}00144\ DGRVertex\ *}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00145}00145\ DGRCandidateQueue::Find\ (\textcolor{keyword}{const}\ Ipv4Address\ addr)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00148}00148\ \ \ DGRCandidateList\_t::const\_iterator\ \mbox{\hyperlink{namespacens3_aa5e169e2453984d2f21c0d5cec9e907b}{i}}\ =\ m\_candidates.begin\ ();}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00149}00149\ }
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00150}00150\ \ \ \textcolor{keywordflow}{for}\ (;\ \mbox{\hyperlink{namespacens3_aa5e169e2453984d2f21c0d5cec9e907b}{i}}\ !=\ m\_candidates.end\ ();\ \mbox{\hyperlink{namespacens3_aa5e169e2453984d2f21c0d5cec9e907b}{i}}++)}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00151}00151\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00152}00152\ \ \ \ \ \ \ DGRVertex\ *v\ =\ *\mbox{\hyperlink{namespacens3_aa5e169e2453984d2f21c0d5cec9e907b}{i}};}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00153}00153\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (v-\/>GetVertexId\ ()\ ==\ addr)}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00163}00163\ DGRCandidateQueue::Reorder\ (\textcolor{keywordtype}{void})}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00167}00167\ \ \ m\_candidates.sort\ (\&DGRCandidateQueue::CompareDGRVertex);}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00180}00180\ DGRCandidateQueue::CompareDGRVertex\ (\textcolor{keyword}{const}\ DGRVertex*\ v1,\ \textcolor{keyword}{const}\ DGRVertex*\ v2)}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00185}00185\ \ \ \textcolor{keywordflow}{if}\ (v1-\/>GetDistanceFromRoot\ ()\ <\ v2-\/>GetDistanceFromRoot\ ())}
...
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00189}00189\ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (v1-\/>GetDistanceFromRoot\ ()\ ==\ v2-\/>GetDistanceFromRoot\ ())}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00190}00190\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00191}00191\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (v1-\/>GetVertexType\ ()\ ==\ DGRVertex::VertexNetwork\ }
\DoxyCodeLine{\Hypertarget{dgr-candidate-queue_8cc_source_l00192}00192\ \ \ \ \ \ \ \ \ \ \ \&\&\ v2-\/>GetVertexType\ ()\ ==\ DGRVertex::VertexRouter)}
