...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00021}00021\ \textcolor{preprocessor}{\#include\ "{}dgr-\/application-\/helper.h"{}}}
...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00029}00029\ DGRApplicationHelper::DGRApplicationHelper\ (std::string\ protocol,\ Address\ address)}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00030}00030\ \{}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00031}00031\ \ \ m\_factory.SetTypeId\ (\textcolor{stringliteral}{"{}ns3::DGRPacketSink"{}});}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00032}00032\ \ \ m\_factory.Set\ (\textcolor{stringliteral}{"{}Protocol"{}},\ StringValue\ (protocol));}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00033}00033\ \ \ m\_factory.Set\ (\textcolor{stringliteral}{"{}Local"{}},\ AddressValue\ (address));}
...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00036}00036\ DGRApplicationHelper::\string~DGRApplicationHelper()}
...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00041}00041\ DGRApplicationHelper::SetAttribute\ (std::string\ name,\ \textcolor{keyword}{const}\ AttributeValue\ \&value)}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00042}00042\ \{}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00043}00043\ \ \ m\_factory.Set\ (name,\ value);}
...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00047}00047\ DGRApplicationHelper::Install\ (Ptr<Node>\ node)\textcolor{keyword}{\ const}}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00048}00048\ \textcolor{keyword}{}\{}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00049}00049\ \ \ \textcolor{keywordflow}{return}\ ApplicationContainer\ (InstallPriv\ (node));}
...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00053}00053\ DGRApplicationHelper::Install\ (std::string\ nodeName)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00056}00056\ \ \ \textcolor{keywordflow}{return}\ ApplicationContainer\ (InstallPriv\ (node));}
...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00060}00060\ DGRApplicationHelper::Install\ (NodeContainer\ c)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00065}00065\ \ \ \ \ \ \ apps.Add\ (InstallPriv\ (*\mbox{\hyperlink{namespacens3_aa5e169e2453984d2f21c0d5cec9e907b}{i}}));}
...
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00072}00072\ DGRApplicationHelper::InstallPriv\ (Ptr<Node>\ node)\textcolor{keyword}{\ const}}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00073}00073\ \textcolor{keyword}{}\{}
\DoxyCodeLine{\Hypertarget{dgr-application-helper_8cc_source_l00074}00074\ \ \ Ptr<Application>\ app\ =\ m\_factory.Create<Application>\ ();}
