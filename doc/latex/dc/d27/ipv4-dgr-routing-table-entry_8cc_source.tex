...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00003}00003\ \textcolor{preprocessor}{\#include\ "{}ipv4-\/dgr-\/routing-\/table-\/entry.h"{}}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00016}00016\ Ipv4DGRRoutingTableEntry::Ipv4DGRRoutingTableEntry\ ()}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00024}00024\ Ipv4DGRRoutingTableEntry::Ipv4DGRRoutingTableEntry\ (Ipv4DGRRoutingTableEntry\ \textcolor{keyword}{const}\ \&route)}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00036}00036\ Ipv4DGRRoutingTableEntry::Ipv4DGRRoutingTableEntry\ (Ipv4DGRRoutingTableEntry\ \textcolor{keyword}{const}\ *route)}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00047}00047\ Ipv4DGRRoutingTableEntry::Ipv4DGRRoutingTableEntry\ (Ipv4Address\ dest,}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00059}00059\ Ipv4DGRRoutingTableEntry::Ipv4DGRRoutingTableEntry\ (Ipv4Address\ dest,}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00070}00070\ Ipv4DGRRoutingTableEntry::Ipv4DGRRoutingTableEntry\ (Ipv4Address\ network,}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00084}00084\ Ipv4DGRRoutingTableEntry::Ipv4DGRRoutingTableEntry\ (Ipv4Address\ network,}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00104}00104\ Ipv4DGRRoutingTableEntry::Ipv4DGRRoutingTableEntry\ (Ipv4Address\ dest,}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00121}00121\ Ipv4DGRRoutingTableEntry::IsHost\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00124}00124\ \ \ \textcolor{keywordflow}{if}\ (m\_destNetworkMask\ ==\ Ipv4Mask::GetOnes\ ())}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00134}00134\ Ipv4DGRRoutingTableEntry::GetDest\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00137}00137\ \ \ \textcolor{keywordflow}{return}\ m\_dest;}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00140}00140\ Ipv4DGRRoutingTableEntry::IsNetwork\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00143}00143\ \ \ \textcolor{keywordflow}{return}\ !IsHost\ ();}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00146}00146\ Ipv4DGRRoutingTableEntry::IsDefault\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00149}00149\ \ \ \textcolor{keywordflow}{if}\ (m\_dest\ ==\ Ipv4Address::GetZero\ ())}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00159}00159\ Ipv4DGRRoutingTableEntry::GetDestNetwork\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00162}00162\ \ \ \textcolor{keywordflow}{return}\ m\_dest;}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00165}00165\ Ipv4DGRRoutingTableEntry::GetDestNetworkMask\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00168}00168\ \ \ \textcolor{keywordflow}{return}\ m\_destNetworkMask;}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00171}00171\ Ipv4DGRRoutingTableEntry::IsGateway\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00174}00174\ \ \ \textcolor{keywordflow}{if}\ (m\_gateway\ ==\ Ipv4Address::GetZero\ ())}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00184}00184\ Ipv4DGRRoutingTableEntry::GetGateway\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00187}00187\ \ \ \textcolor{keywordflow}{return}\ m\_gateway;}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00191}00191\ Ipv4DGRRoutingTableEntry::GetInterface\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00194}00194\ \ \ \textcolor{keywordflow}{return}\ m\_interface;}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00198}00198\ Ipv4DGRRoutingTableEntry::GetNextInterface\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00201}00201\ \ \ \textcolor{keywordflow}{return}\ m\_nextInterface;}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00205}00205\ Ipv4DGRRoutingTableEntry::GetDistance\ (\textcolor{keywordtype}{void})\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00208}00208\ \ \ \textcolor{keywordflow}{return}\ m\_distance;}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00211}00211\ Ipv4DGRRoutingTableEntry\ }
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00212}00212\ Ipv4DGRRoutingTableEntry::CreateHostRouteTo\ (Ipv4Address\ dest,\ }
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00217}00217\ \ \ \textcolor{keywordflow}{return}\ Ipv4DGRRoutingTableEntry\ (dest,\ nextHop,\ interface);}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00218}00218\ \}}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00219}00219\ Ipv4DGRRoutingTableEntry\ }
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00220}00220\ Ipv4DGRRoutingTableEntry::CreateHostRouteTo\ (Ipv4Address\ dest,}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00224}00224\ \ \ \textcolor{keywordflow}{return}\ Ipv4DGRRoutingTableEntry\ (dest,\ interface);}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00231}00231\ Ipv4DGRRoutingTableEntry}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00232}00232\ Ipv4DGRRoutingTableEntry::CreateHostRouteTo\ (Ipv4Address\ dest,\ }
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00240}00240\ \ \ \textcolor{keywordflow}{return}\ Ipv4DGRRoutingTableEntry\ (dest,\ nextHop,\ interface,\ nextInterface,\ distance);}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00243}00243\ Ipv4DGRRoutingTableEntry\ }
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00244}00244\ Ipv4DGRRoutingTableEntry::CreateNetworkRouteTo\ (Ipv4Address\ network,\ }
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00250}00250\ \ \ \textcolor{keywordflow}{return}\ Ipv4DGRRoutingTableEntry\ (network,\ networkMask,\ }
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00253}00253\ Ipv4DGRRoutingTableEntry\ }
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00254}00254\ Ipv4DGRRoutingTableEntry::CreateNetworkRouteTo\ (Ipv4Address\ network,\ }
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00259}00259\ \ \ \textcolor{keywordflow}{return}\ Ipv4DGRRoutingTableEntry\ (network,\ networkMask,\ }
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00262}00262\ Ipv4DGRRoutingTableEntry\ }
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00263}00263\ Ipv4DGRRoutingTableEntry::CreateDefaultRoute\ (Ipv4Address\ nextHop,\ }
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00267}00267\ \ \ \textcolor{keywordflow}{return}\ Ipv4DGRRoutingTableEntry\ (Ipv4Address::GetZero\ (),\ Ipv4Mask::GetZero\ (),\ nextHop,\ interface);}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00271}\mbox{\hyperlink{namespacens3_a3787fb12a1be1beee9d72d834b8a76a5}{00271}}\ std::ostream\&\ operator<<\ (std::ostream\&\ os,\ Ipv4DGRRoutingTableEntry\ \textcolor{keyword}{const}\&\ route)}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00272}00272\ \{}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00273}00273\ \ \ \textcolor{keywordflow}{if}\ (route.IsDefault\ ())}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00274}00274\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00275}00275\ \ \ \ \ \ \ NS\_ASSERT\ (route.IsGateway\ ());}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00276}00276\ \ \ \ \ \ \ os\ <<\ \textcolor{stringliteral}{"{}default\ out="{}}\ <<\ route.GetInterface\ ()\ <<\ \textcolor{stringliteral}{"{},\ next\ hop="{}}\ <<\ route.GetGateway\ ();}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00277}00277\ \ \ \ \ \}}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00278}00278\ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (route.IsHost\ ())}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00279}00279\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00280}00280\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (route.IsGateway\ ())}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00281}00281\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00282}00282\ \ \ \ \ \ \ \ \ \ \ os\ <<\ \textcolor{stringliteral}{"{}host="{}}<<\ route.GetDest\ ()\ <<\ }
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00283}00283\ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{},\ out="{}}\ <<\ route.GetInterface\ ()\ <<}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00284}00284\ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{},\ next\ hop="{}}\ <<\ route.GetGateway\ ();}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00288}00288\ \ \ \ \ \ \ \ \ \ \ os\ <<\ \textcolor{stringliteral}{"{}host="{}}<<\ route.GetDest\ ()\ <<\ }
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00289}00289\ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{},\ out="{}}\ <<\ route.GetInterface\ ();}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00292}00292\ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (route.IsNetwork\ ())\ }
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00293}00293\ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00294}00294\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (route.IsGateway\ ())}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00295}00295\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00296}00296\ \ \ \ \ \ \ \ \ \ \ os\ <<\ \textcolor{stringliteral}{"{}network="{}}\ <<\ route.GetDestNetwork\ ()\ <<}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00297}00297\ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{},\ mask="{}}\ <<\ route.GetDestNetworkMask\ ()\ <<}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00298}00298\ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{},out="{}}\ <<\ route.GetInterface\ ()\ <<}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00299}00299\ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{},\ next\ hop="{}}\ <<\ route.GetGateway\ ();}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00303}00303\ \ \ \ \ \ \ \ \ \ \ os\ <<\ \textcolor{stringliteral}{"{}network="{}}\ <<\ route.GetDestNetwork\ ()\ <<}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00304}00304\ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{},\ mask="{}}\ <<\ route.GetDestNetworkMask\ ()\ <<}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00305}00305\ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{},out="{}}\ <<\ route.GetInterface\ ();}
...
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00315}\mbox{\hyperlink{namespacens3_a31be9c355502d5d92cd252ad21233aeb}{00315}}\ \textcolor{keywordtype}{bool}\ operator==\ (\textcolor{keyword}{const}\ Ipv4DGRRoutingTableEntry\ a,\ \textcolor{keyword}{const}\ Ipv4DGRRoutingTableEntry\ b)}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00316}00316\ \{}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00317}00317\ \ \ \textcolor{keywordflow}{return}\ (a.GetDest\ ()\ ==\ b.GetDest\ ()\ \&\&\ }
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00318}00318\ \ \ \ \ \ \ \ \ \ \ a.GetDestNetworkMask\ ()\ ==\ b.GetDestNetworkMask\ ()\ \&\&}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00319}00319\ \ \ \ \ \ \ \ \ \ \ a.GetGateway\ ()\ ==\ b.GetGateway\ ()\ \&\&}
\DoxyCodeLine{\Hypertarget{ipv4-dgr-routing-table-entry_8cc_source_l00320}00320\ \ \ \ \ \ \ \ \ \ \ a.GetInterface\ ()\ ==\ b.GetInterface\ ());}
