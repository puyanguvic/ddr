...
int main (int argc, char *argv[])
{
  ...
  // // uint32_t budget1 = 8;
  // app1->Setup (ns3udpSocket1, sinkAddress1, 150, 1000000, DataRate ("10Mbps"), false);
  ...
  //   Simulator::Schedule (Seconds (3),&Ipv4::SetDown,ipv42, ipv4ifIndex2);
  // Simulator::Schedule (Seconds (5),&Ipv4::SetUp,ipv42, ipv4ifIndex2);
